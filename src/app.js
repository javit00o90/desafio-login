...
app.use(sessions(
    {
        secret:"javicoder9090",
        resave: true, saveUninitialized: true,
        store: mongoStore.create(
            {
                mongoUrl:'mongodb+srv://javicoder:javicoder@ecommerce.rphonjw.mongodb.net',
...
// Conexión MongoDB
try {
    await mongoose.connect('mongodb+srv://javicoder:javicoder@ecommerce.rphonjw.mongodb.net', { dbName: 'ecommerce' })
